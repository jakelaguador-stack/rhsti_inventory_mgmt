...
<div class="container-fluid py-4" style="max-width: 1600px;">
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6">
      <a href="stock_list.php" class="text-decoration-none">
         <div class="premium-dash-card">
    ...
    <div class="col-md-3 col-sm-6">
      <a href="used_items.php" class="text-decoration-none">
         <div class="premium-dash-card">
           <div class="dash-icon-box bg-academic-blue">
            ...
            <?php foreach ($recent_products as $recent_product): ?>
              ...
              <a class="list-group-item d-flex align-items-center justify-content-between text-decoration-none" href="edit_product.php?id=<?php echo (int)$recent_product['id'];?>">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php
                      $recent_image = isset($recent_product['image']) ? basename($recent_product['image']) : '';
                      $recent_image_path = __DIR__ . '/uploads/products/' . $recent_image;
                      $show_recent_image = !empty($recent_product['media_id']) && $recent_product['media_id'] !== '0' && !empty($recent_image) && file_exists($recent_image_path);
                    ?>

                    <?php if($show_recent_image): ?>

                      <img class="img-avatar-school" src="uploads/products/<?php echo $recent_image;?>" alt="Product Image" />
